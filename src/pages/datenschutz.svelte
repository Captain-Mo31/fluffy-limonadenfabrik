...
<ul>
  <li>
    Auskunft über Ihre bei uns gespeicherten Daten und deren Verarbeitung (Art.
    15 DSGVO),
  </li>
...
<p>
  ...
  personenbezogene Daten, die über eine Eingabemaske an uns übermittelt werden.
</p>
<p />
<p>
  Ihre Registrierung ist für das Bereithalten bestimmter Inhalte und Leistungen
...
<p>
  ...
  auf Basis Ihrer Einwilligung. Ohne die Bereitstellung Ihrer personenbezogenen
  Daten können wir Ihnen keinen Zugang auf unsere angebotenen Inhalte gewähren.
</p>
<p />
...
<p>
  ...
  Bereitstellung Ihrer personenbezogenen Daten können wir Ihnen keinen Zugang
...
<p>
  ...
  dass der betroffene Sachverhalt abschließend geklärt ist. Wir behalten uns die
  Löschung ohne Angaben von Gründen und ohne vorherige oder nachträgliche
  Information vor.
</p>
<p>
...
<h3>Art und Zweck der Verarbeitung:</h3>
<p>
  Für die Zustellung unseres Newsletters erheben wir personenbezogene Daten, die
...
<p>
  ...
  oder uns Ihren Widerruf über die am Ende dieser Datenschutzhinweise angegebene
...
<p>
  Die Einwilligung zur Speicherung Ihrer persönlichen Daten und ihrer Nutzung
  für den Newsletterversand können Sie jederzeit mit Wirkung für die Zukunft
  widerrufen. Die Abmeldung kann über den in jeder E-Mail enthaltenen Link oder
  beim unten aufgeführten Datenschutzbeauftragten bzw. der für den Datenschutz
...
<p>
  ...
  (nachfolgend „Google“) betrieben. Dadurch können wir Ihnen interaktive Karten
  direkt in der Webseite anzeigen und ermöglichen Ihnen die komfortable Nutzung
  der Karten-Funktion.<br />Nähere Informationen über die Datenverarbeitung
...
<p>
  ...
  Google-Produkten finden Sie hier: <a
...
<p>
  ...
  und/oder bedarfsgerechter Gestaltung seiner Websites. Eine solche Auswertung
...
<p>
  ...
  Ihrer Aktivitäten auf unserer Website verhindern wollen, widerrufen Sie bitte
  im Cookie-Consent-Tool Ihre Einwilligung für die entsprechende
...
<p>
  ...
  Tochtergesellschaft der Google LLC, 1600 Amphitheatre Pkwy, Mountain View, CA
  94043, USA (nachfolgend „Google“). Wenn Sie eine Seite mit dem YouTube-Plugin
